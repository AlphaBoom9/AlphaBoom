...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("AlphaBooms"));
    case mBTC: return QString(QObject::tr("Milli-AlphaBooms (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-AlphaBooms (1 / 1,000,000)"));
    default: return QString("???");
    }
}
