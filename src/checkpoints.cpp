...
namespace Checkpoints
{
    ...
    // AlphaBoom: synchronized checkpoint (centrally broadcasted)
    ...
    // AlphaBoom: get last synchronized checkpoint
    ...
    // AlphaBoom: only descendant of current sync-checkpoint is allowed
    ...
    // AlphaBoom: reset synchronized checkpoint to last hardened checkpoint
...
// AlphaBoom: sync-checkpoint master key
...
// AlphaBoom: verify signature of sync-checkpoint message
