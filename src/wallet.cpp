...
// AlphaBoom: optional setting to unlock wallet for block minting only;
...
// AlphaBoom: check 'spent' consistency between wallet and txindex
// AlphaBoom: fix wallet spent state according to txindex
...
// AlphaBoom: disable transaction (only for coinstake)
