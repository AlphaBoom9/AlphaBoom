...
static const char *strDNSSeed[][2] = {
    {"node.AlphaBoom.karelia.pro", "dnsseed.AlphaBoom.karelia.pro"},
    {"AlphaBoom.ru", "dnsseed.AlphaBoom.ru"},
    {"AlphaBoom.ru", "testseed.AlphaBoom.ru"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("AlphaBoom-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("AlphaBoom-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("AlphaBoom-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("AlphaBoom-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. AlphaBoom is probably already running."), addrBind.ToString().c_str());
        else
